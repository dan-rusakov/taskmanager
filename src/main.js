...
render(mainElement, filtersTemplate());
render(mainElement, boardTemplate());
render(headerElement, menuTemplate());

const boardElement = document.querySelector('.board');
const tasksElement = document.querySelector('.board__tasks');

render(boardElement, loadMoreBtnTemplate());
render(tasksElement, taskEditTemplate());

for (let i = 0; i < TASKS_COUNT; i++) {
    render(tasksElement, taskTemplate());
}
